...
public interface MessageMapper {
    ...
    @Insert({
        ...
        "#{msg,jdbcType=VARCHAR}, #{hasRead,jdbcType=BOOLEAN}, #{fromTask,jdbcType=INTEGER})"
    })
    ...
    @ConstructorArgs({
        ...
        @Arg(column="from_task", javaType=Integer.class, jdbcType=JdbcType.INTEGER)
    })
    ...
    @Update({
        ...
        "set from_player = #{fromPlayer,jdbcType=INTEGER},",
          ...
          "from_task = #{fromTask,jdbcType=INTEGER}",
        "where id = #{id,jdbcType=INTEGER}"
    })
