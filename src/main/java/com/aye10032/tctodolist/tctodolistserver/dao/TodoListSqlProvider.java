...
public class TodoListSqlProvider {
    ...
    public String insertSelective(TodoList record) {
        ...
        if (record.getLastUpdateTime() != null) {
            sql.VALUES("last_update_time", "#{lastUpdateTime,jdbcType=VARCHAR}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getLastUpdateTime() != null) {
            sql.SET("last_update_time = #{record.lastUpdateTime,jdbcType=VARCHAR}");
        }
    ...
    public String updateByPrimaryKeySelective(TodoList record) {
        ...
        if (record.getLastUpdateTime() != null) {
            sql.SET("last_update_time = #{lastUpdateTime,jdbcType=VARCHAR}");
        }
